...
<template>
  <aside class="flex h-full w-[320px] shrink-0 flex-col overflow-y-auto bg-white px-4 pb-4">
    ...
    <section class="mt-5 rounded-xl border border-slate-100 bg-slate-50 p-3">
      <p class="text-xs font-semibold text-slate-700">Session Context</p>
      <dl class="mt-2 space-y-1.5 text-[13px]">
        <div class="flex justify-between gap-2">
          <dt class="text-slate-400">Topic</dt>
          <dd class="font-medium text-slate-800">{{ topicLabel }}</dd>
        </div>
        <div class="flex justify-between gap-2">
          <dt class="text-slate-400">Role</dt>
          <dd class="text-right font-medium text-slate-800">{{ roleLabel }}</dd>
        </div>
        <div class="flex justify-between gap-2">
          <dt class="text-slate-400">Duration</dt>
          <dd class="font-medium text-slate-800">This session</dd>
        </div>
      </dl>
    </section>
